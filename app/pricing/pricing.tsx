...
export function Pricing({ config, countryCode, email, configurationError }: Props) {
  ...
  return <main className="paddle-pricing">
    ...
    <div className="paddle-content">
      ...
      <footer className="paddle-footer"><span>Built for your next chapter.</span><div><a href="/terms">Terms & Conditions</a><a href="mailto:kamzewac@gmail.com">Contact support</a></div></footer>
    </div>
  </main>;
}
